...
public class AgendaEventos {
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2024, Month.JULY, 15), "Evento 5", "Atração 5");
        agendaEventos.adicionarEvento(LocalDate.of(2024, 6, 6), "Evento 4", "Atração 4");
